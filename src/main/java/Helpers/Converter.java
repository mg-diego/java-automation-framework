...
public class Converter {
    ...
    public static ConfigurationList fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(ConfigurationList obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(ConfigurationList.class);
        writer = mapper.writerFor(ConfigurationList.class);
    }
